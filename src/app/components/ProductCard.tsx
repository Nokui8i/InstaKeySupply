  ...
  return (
    ...
    >
      ...
      <div className="w-full text-center flex-1 flex flex-col justify-between">
        <h3 className="product__title text-gray-900 text-xs sm:text-sm leading-tight mb-1 hover:text-blue-500 transition-colors cursor-pointer h-20 overflow-hidden">
          {title}
        </h3>
        ...
        <div className="flex items-center justify-center gap-2 mb-3">
          ...
          <span className="product__price bg-gradient-to-r from-blue-700 to-blue-500 text-white font-bold text-sm sm:text-base px-3 py-1 rounded-full shadow-sm">
            {price}
          </span>
        </div>
      </div>
